  ...
  return (
    <div className="navbar bg-base-100 shadow-xl">
      <div className="flex-none">
        <button className="btn btn-square btn-ghost" title="bar">
          <svg
      ...
      <div className="flex-auto gap-6">
        <div className="flex justify-evenly w-10/12">
            <Link href={"/"} className="hover:text-rose-500">Aahzi</Link>
            <Link href={"/form"} className="hover:text-rose-500">Form</Link>
